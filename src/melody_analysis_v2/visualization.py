...
CAPLIN_METADATA = {
    "presentación": {"abbr": "Pres", "full": "Presentation", "color": "#A0E0E6"},
    "continuación": {"abbr": "Cont", "full": "Continuation", "color": "#F4C2E0"},
    "antecedente": {"abbr": "Ant", "full": "Antecedent", "color": "#EF9A9A"},
    "consecuente": {"abbr": "Cons", "full": "Consequent", "color": "#A5D6A7"},
    "extensión cadencial": {"abbr": "CE", "full": "Cadential Extension", "color": "#CDB5B1"},
    "silencio": {"abbr": "S", "full": "Silence", "color": "#E0E0E0"},
    "pregunta": {"abbr": "Q", "full": "Question", "color": "#EF9A9A"},
    "respuesta": {"abbr": "A", "full": "Answer", "color": "#A5D6A7"},
    "cadencia": {"abbr": "Cad", "full": "Cadence", "color": "#CDB5B1"},
    "exposición": {"abbr": "Exp", "full": "Exposition", "color": "#A0E0E6"},
    "desarrollo": {"abbr": "Dev", "full": "Development", "color": "#F4C2E0"},
    "transición": {"abbr": "Trans", "full": "Transition", "color": "#FFF59D"},
    "afirmación": {"abbr": "Stmt", "full": "Statement", "color": "#D1C4E9"},
}
...
def _get_caplin_meta(label: str) -> dict:
    ...
    mapping = {
        ...
        "extensión cadencial": "extensión cadencial",
        "extension cadencial": "extensión cadencial",
        "cadential extension": "extensión cadencial",
        "ec": "extensión cadencial",
        "ce": "extensión cadencial",
