...
class MelodyAnalyzer:
    ...
    def analyze_features(
        ...
        *,
        ...
        ssm_step = getattr(self.segmenter, "last_step", 1)
        annotations = self.classifier.classify(features, segments, self_similarity, ssm_step=ssm_step)
    ...
    def analyze_audio(self, audio: np.ndarray, sample_rate: int, label: str = "") -> MelodyAnalysisResult:
