#!/usr/bin/env python3
"""
MC-MSA: Single Track Melodic Structure Analysis
===============================================
Analyzes a single audio recording (.mp3 or .wav), performing:
1. Melodic F0 & energy extraction
2. SSM self-similarity computation and novelty-based boundary detection
3. Caplin formal function classification (A / C / X)
4. Visualization plots and synthesized melody generation
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Analyze a single audio file using the MC-MSA pipeline.")
    ...
    parser.add_argument("--output_dir", type=str, default="outputs_single_track",
